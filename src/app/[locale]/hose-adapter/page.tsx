...
function ModelContainerLoading() {
...
export default function HoseAdapterPage() {
  const t = useTranslations("Products.hoseAdapter");
  const tParams = useTranslations("Products.hoseAdapter.parameters");
  const tValidation = useTranslations("Validation");

  // Get translated schema
  const schema = getTranslatedSchema(tParams);
  ...
  const validation = validateParameters(schema, parameters, tValidation);
